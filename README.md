...
cd dhd2020
```
3. Run the following network from Detectron's model zoo:
```
...
1. Add your own categories to the text file 'labels'
...
```
3. Convert into COCO json
```

```
4. Test annotations in Jupyter notebook
